...
var findRadius = function (houses, heaters) {
  const max = houses.reduce((maxDistance, house) => {
    const distance = heaters.reduce((minDistance, heater) => {
      const min = Math.abs(heater - house)
      return min < minDistance ? min : minDistance
    }, Infinity)
